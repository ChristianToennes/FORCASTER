...
def bfgs(cur, reg_config, c):
    ...
    if config["my"]:
        ...
        if c==-43:
            ...
            x, score = cma.fmin2(f, np.array([0,0,0,0,0,0]), 1, args=(cur,eps,config), gradf=gradf3, options={'ftarget': 0.001, 'maxiter': 100})
        ...
        if c==-57:
            ...
            eps = [1, 1, 1, 5, 5, 10]
            x, score = cma.fmin2(f, np.array([0,0,0,0,0,0]), 1, args=(cur,eps,config), gradf=gradf3, options={'ftarget': 0.5, 'maxiter': 30})
            eps = [0.1, 0.1, 0.1, 1, 1, 5]
            x, score = cma.fmin2(f, np.array(x), 0.1, args=(cur,eps,config), gradf=gradf3, options={'ftarget': 0.1, 'maxiter': 30})
            eps = [0.01, 0.01, 0.01, 0.1, 0.1, 1]
            x, score = cma.fmin2(f, np.array(x), 0.01, args=(cur,eps,config), gradf=gradf3, options={'ftarget': 0.001, 'maxiter': 30})
            ret = SimpleNamespace(x=x)
        elif c==-71:
            eps = [20, 20, 20, 10, 10, 10]
            x, score = cma.fmin2(f, np.array([0,0,0,0,0,0]), 5, args=(cur,eps,config), gradf=gradf, options={'ftarget': 0.1, 'maxiter': 200})
            eps = [5, 5, 5, 5, 5, 5]
            x, score = cma.fmin2(f, np.array(x), 1, args=(cur,eps,config), gradf=gradf, options={'ftarget': 0.1, 'maxiter': 200})
            eps = [0.1, 0.1, 0.1, 1, 1, 1]
            x, score = cma.fmin2(f, np.array(x), 0.1, args=(cur,eps,config), gradf=gradf, options={'ftarget': 0.01, 'maxiter': 200})
            eps = [0.01, 0.01, 0.01, 0.1, 0.1, 0.1]
            x, score = cma.fmin2(f, np.array(x), 0.01, args=(cur,eps,config), gradf=gradf, options={'ftarget': 0.001, 'maxiter': 200})
            ret = SimpleNamespace(x=x)
