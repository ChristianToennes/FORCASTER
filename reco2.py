...
def normalize(images, mAs_array, kV_array, gammas):
...
def read_dicoms(indir):
    ...
    ims = normalize(ims, μas, kvs, gammas)
...
data = [#('lumb_cbct_', 'C:\\Users\\ich\\Source\\reco\\CKM_LumbalSpine\\20201013-163837.330000\\5sDR Body'),
